...
public class CadastroCadGrupo {
     public static void Cadastrar(String descricao) {
        ...
        try {
            ...
            String sql = "INSERT INTO CADGRUPOS (DESCRICAO)"
                    + "VALUES ('"+ descricao +"')";
            ...
            System.err.println(e.getClass().getName() + "Erro no Insert classe(CadGrupo) " + e.getMessage());
